 ...
 */
public class MyDownloadUpcommingEventTask2 extends AsyncTask<String,Void,EventData> {
    private final WeakReference<UpcommingRecyclerAdapter> adapterReference;
    EventData Data;
    // RecyclerAdapter adapter;
    public MyDownloadUpcommingEventTask2(UpcommingRecyclerAdapter adapter,EventData Data)
